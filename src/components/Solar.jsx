  ...
  return (<>
    <div>
      ...
      <section className="plant-cards">
        ...
        <div class="solar-types">
          <div class="solar-type">
            <h2>On-Grid Solar Plants</h2>
            ...
            <Link to='/order' class="order-btn" state={{ type: "On-Grid" }}>Order Now</Link>
            <p class="note">* Fixed price: ₹60 per watt</p>
          ...
          <div class="solar-type">
            ...
            <Link to='/order' class="order-btn" state={{ type: "Off-Grid" }}>Order Now</Link>
            <p class="note">* Fixed price: ₹42 per watt (Battery charges extra depending on choice)</p>
          </div>
        </div>

    <p class="note">We are constantly upgrading our technology. With advancements, it is possible to have 1 KW generated by a single solar panel in the future, reducing the area required for installation.</p>
  </section >
    </div >
    <Footer />
</>
